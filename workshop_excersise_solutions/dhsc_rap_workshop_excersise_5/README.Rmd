...
The intent of dhsc_rap_workshop is to act as an example of how to produce a simple RAP

## Description

This RAP is an example, created by following the examples in the DHSC RAP Workshop book.
It will contain scripts to:

- Download data from the internet
- Manipulate, summarsie and plot the data
- Document the process so it can be run by other users.
...
Please note that the dhsc_rap_workshop_excersise_1 project is released with a [Contributor Code of Conduct](https://contributor-covenant.org/version/2/1/CODE_OF_CONDUCT.html). By contributing to this project, you agree to abide by its terms.
