...
#'
#'
download_data_from_ons <- function(data_dictionary_url, data_id){
...
process_data <- function(data_id, industry, geography, metric){
  ...
  # save data to csv
  output_file_name <- paste0("output/", data_id, "_", metric, "_time_series_sorted.csv")
...
ts_line_chart_data <- function(data, industry, metric, title, subtitle, xlab, ylab){
  ...
  graph <- ggplot2::ggplot(data = data,
    ...
    #save chart
  chart_path <- paste0("./output/", metric, "_chart.svg")
